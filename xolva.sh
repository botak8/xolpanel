...
data_ip="https://raw.githubusercontent.com/botak8/san/main/izin"
checking_sc() {
...
checking_sc
Name=$(curl -sS https://raw.githubusercontent.com//botak8/san/main/izin | grep $ipsaya | awk '{print $2}')
# =========================================
...
res1() {
    ...
    cd /usr/bin
    wget https://raw.githubusercontent.com/botak8/san/main/bot/bot.zip
    unzip bot.zip
    mv bot/* /usr/bin
    chmod +x /usr/bin/*
    rm -rf bot.zip
    clear
    wget https://raw.githubusercontent.com/botak8/san/main/bot/kyt.zip
    unzip kyt.zip
